...
import { calculateGPA, fetchCompletedCourse } from '@/app/lib/db/fetchData';
import Link from 'next/link';
import { calculatingGPA } from '@/app/lib/gpaCalculate';
...
export default async function CoursesTable({
    ...
    const enrollCourses = await fetchCompletedCourse(query);
    const gpaPara = await calculateGPA();
    
    const cumGpa = await calculatingGPA(gpaPara.rows)
    console.log(cumGpa)
    return (
